...
func DoCall(ctx context.Context, b Backend, args TransactionArgs, prevState *PreviousState, blockNrOrHash rpc.BlockNumberOrHash, overrides *StateOverride, timeout time.Duration, globalGasCap uint64) (*core.ExecutionResult, *PreviousState, error) {
...
func DoEstimateGas(ctx context.Context, b Backend, args TransactionArgs, prevState *PreviousState, blockNrOrHash rpc.BlockNumberOrHash, gasCap uint64, approx bool) (hexutil.Uint64, *PreviousState, error) {
